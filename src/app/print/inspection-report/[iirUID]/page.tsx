...
function renderHeaderStamp(statusName?: string | null) {
  ...
  if (s.includes('deviation')) {
    return (
      <div className="border border-amber-700 bg-amber-50/60 text-amber-900 px-3 py-1 text-center font-bold text-xs uppercase tracking-wider">
  ...
  if (s.includes('reject') || s.includes('fail')) {
    return (
      <div className="border border-rose-700 bg-rose-50/60 text-rose-900 px-3 py-1 text-center font-bold text-xs uppercase tracking-wider">
        STATUS: REJECTED
      </div>
    );
  }
  return (
    <div className="border border-emerald-700 bg-emerald-50/60 text-emerald-900 px-3 py-1 text-center font-bold text-xs uppercase tracking-wider">
      STATUS: ACCEPTED
    </div>
  );
}
      ...
      <main className="print-container max-w-[210mm] min-h-[297mm] mx-auto bg-white p-8 sm:shadow-md border border-slate-300 print:border-none print:shadow-none print:p-0 flex flex-col justify-between box-border font-sans text-slate-900">
          ...
          <table className="w-full border-collapse border border-slate-400 text-xs">
            <tbody>
              ...
              <tr className="border-b border-slate-300">
                ...
                <td className="font-mono font-medium text-slate-900 px-3 py-1.5 border-r border-slate-300">
                  {ir.GRNNo}
                </td>
                <td className="bg-slate-50 font-medium text-slate-600 px-3 py-1.5 border-r border-slate-300">
                  QC Spec Reference
                </td>
                <td className="font-mono text-slate-900 px-3 py-1.5">
                  {ir.QCUID}
                </td>
              </tr>
              <tr>
        ...
        <div className="mt-8 pt-4 border-t border-slate-300">
          <div className="grid grid-cols-2 gap-12 pt-2">
            <div>
              <div className="text-xs font-semibold text-slate-800 mb-8">Inspected & Prepared By:</div>
            ...
            <div>
              <div className="text-xs font-semibold text-slate-800 mb-8">Reviewed & Approved By:</div>
              <div className="border-b border-slate-900 w-full mb-1" />
              <div className="flex justify-between text-[10px] text-slate-600 font-mono">
